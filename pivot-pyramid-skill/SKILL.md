...
- **`references/layer-definitions.md`** — Deep validation questions for each layer
- **`references/evidence-hierarchy.md`** — Evidence assessment framework with checklists
- **`references/cascade-analysis.md`** — Full cascade checklists by pivot type

### Diagnostic References
- **`references/diagnostic-guide.md`** — Symptom → root cause mapping, Five Whys technique
- **`references/anti-patterns.md`** — Red flags and common mistakes
- **`references/90-day-rule.md`** — When NOT to pivot, anti-pivot checklist

### Execution References
- **`references/pivot-playbooks.md`** — Step-by-step playbooks for each pivot type
